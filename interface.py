...
def account_login_screen():
    ...
    Label(text="Account Login", bg="#66b3ff", width="300", height="2", font=("Calibri", 13)).pack()
    Label(text="").pack()
    ...
    pw_entry.pack()
    Label(text="").pack()
    Button(text="Log In", height="1", width="30", command=login).pack()
    message = Text(login_screen, height=2, width=27)
    message.pack()
